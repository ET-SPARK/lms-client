<template>
      ...
      <div>
        <div class="text-2xl font-bold flex items-center">
          <div class="flex">
            ...
            <div class="ml-4">Andinet LMS</div>
          </div>
          ...
          >
            <input
              ...
              class="bg-gray-700 text-white font-light text-xs px-4 w-[250px] py-2 rounded-sm focus:outline-none focus:shadow-outline"
            />
            <Icon
  ...
  >
    ...
    <div
      class="flex border-gray-200 border-b-2 py-2"
    ...
    <div class="flex-1 font-light mt-4" v-if="isCourse">
      <div class="grid grid-cols-2 gap-5 justify-between mt-4 mb-4">
        ...
        <div class="flex items-center">
          <div class="bg-blue-500 p-1 mr-2 rounded-md">
            <Icon name="ep:brush" class="cursor-pointer text-white text-2xl" />
          </div>
          <div>Art & Crafts</div>
        </div>
        <div class="flex items-center">
